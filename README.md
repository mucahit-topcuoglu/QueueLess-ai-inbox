...
- Kullanılan model: `gemma4:31b-cloud`
- Varsayılan endpoint: `OLLAMA_BASE_URL=http://localhost:11434`
- Varsayılan model: `OLLAMA_MODEL=gemma4:31b-cloud`
...
- Kullanıcı iş ilanı linki veya manuel ilan metni girer.
- PDF CV dosyaları yüklenir.
- `/api/analyze/recruitment` endpoint'i PDF metnini çıkarır, ilan metniyle birlikte Ollama'ya gönderir ve adayları kategorize eder.
- Çıktıda aday adı, match score, kategori, güçlü yanlar, eksik alanlar, riskler ve önerilen aksiyon bulunur.
- İş ilanı linki okunamazsa kullanıcı manuel ilan metni girebilir.

## Internship / Document Analysis

- Kullanıcı PDF belge yükler ve belge türü seçebilir.
- `/api/analyze/document` endpoint'i belge türünü tahmin eder, checklist analizi yapar, eksikleri ve riskleri çıkarır.
- Çıktıda önerilen kuyruk, confidence score, checklist, missing fields, risk flags, AI summary ve insan onayına hazır cevap taslağı bulunur.
- Gerçek mail gönderimi yapılmaz; cevap metni sadece taslaktır.
