...
## Prompt Summary: Switch from Gemma/Ollama to Gemini API

- Date: 2026-05-06
- Owner: Kişi C
- Summary: Kullanıcı, Gemma/Ollama entegrasyonundan Gemini API entegrasyonuna geçilmesini; API key'in sadece `.env.local` içinde tutulmasını; recruitment/CV ve staj/belge analiz endpointlerinin Gemini ile çalışmasını; fallback analyzer, safe JSON parse, PDF validation, health endpoint ve dokümantasyon güncellemelerinin eklenmesini istedi.
